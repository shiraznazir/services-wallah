    ...
    <div className="px-4 sm:px-8 lg:px-20 py-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-8">
        ...
        <div className="lg:col-span-4">
          <h1 className="font-bold text-2xl sm:text-3xl lg:text-4xl text-gray-800 dark:text-gray-100">
            Contact Us
          </h1>
          <ContactForm />
        </div>
        ...
        <div className="lg:col-span-2 flex gap-6">
          ...
          <div className="space-y-6 w-full">
            {/* Get in Touch Card */}
            <div className="border border-gray-300 dark:border-gray-700 dark:bg-gray-800 p-6 rounded shadow-md">
